    ...
    <div class="hidden md:block md:w-4/5 h-screen relative overflow-hidden">
      ...
      <div class="absolute bottom-16 left-16 text-white z-10 max-w-xl">
        ...
        <h1 class="text-6xl lg:text-7xl font-light font-serif leading-tight tracking-wide">
          Romeo <span class="text-amber-200">&</span><br>
          Juliet
        </h1>
      ...
      <div class="relative z-10 h-screen flex flex-col justify-between text-white text-center px-8 py-10">
        ...
        <div>
          ...
          <h1 class="text-4xl md:text-5xl font-light font-serif tracking-wide">
            Romeo <span class="text-amber-200">&</span> Juliet
          </h1>
      ...
      >
              ...
              <div class="absolute inset-0 flex flex-col justify-end p-8 md:p-16 lg:p-24 z-10 w-full max-w-7xl mx-auto">
                ...
                >
                  ...
                  <h2 class="text-5xl md:text-6xl lg:text-7xl font-light text-white font-serif tracking-wide">
                    Romeo Axton<br><span class="italic text-amber-100">Montague</span>
                  </h2>
            ...
            <div class="relative w-full h-screen snap-start group overflow-hidden">
              ...
              >
                ...
                >
                  ...
                  <h2 class="text-5xl md:text-6xl lg:text-7xl font-light text-white font-serif tracking-wide">
                    Juliet<br><span class="italic text-amber-100">Capulet</span>
                  </h2>
          ...
          <div class="relative z-10 w-full max-w-5xl mx-auto px-6 md:px-12">
            ...
            <div class="text-center space-y-4 mb-16 md:mb-20">
              <div class="flex justify-center mb-4">
                <i class="mdi mdi-leaf-maple text-4xl md:text-5xl text-amber-300 animate-pulse" />
              </div>
              <p class="text-xs md:text-sm tracking-[0.3em] uppercase text-amber-200/90 font-medium">
                A Journey in Love
              </p>
              <h2 class="text-4xl md:text-5xl lg:text-5xl font-light text-white font-serif tracking-tight">
              ...
              <div class="relative z-10 space-y-12">
                ...
                <div class="space-y-4">
                  <div class="flex justify-center mb-6">
                    <div class="w-16 h-px bg-gradient-to-r from-transparent via-amber-300 to-transparent mx-2 my-auto" />
                    <i class="mdi mdi-leaf-maple text-3xl md:text-4xl text-amber-300 mx-4" />
                    <div class="w-16 h-px bg-gradient-to-r from-transparent via-amber-300 to-transparent mx-2 my-auto" />
                  </div>
                  <h2 class="text-xs md:text-sm font-medium tracking-[0.4em] uppercase text-amber-200/80">
                    Save Our Date
                  </h2>
                  <p class="text-3xl md:text-5xl font-serif font-medium tracking-tight text-white tracking-wide mt-2">
                    Rabu, 25 Maret 2026
                  </p>
                </div>
              ...
              <div class="space-y-8 lg:text-left">
                ...
                <div class="space-y-4 text-center lg:text-left">
                  <div class="flex justify-center lg:justify-start mb-4">
                    <i class="mdi mdi-leaf-maple text-3xl md:text-4xl text-amber-300" />
                  </div>
                  <h2 class="text-xs md:text-sm font-medium tracking-[0.4em] uppercase text-amber-200/80">
                    RSVP & Wishes
                  </h2>
                  <p class="text-4xl md:text-5xl font-serif font-medium tracking-tight text-white tracking-wide mt-2">
                    Kehadiran Anda
                  </p>
                ...
                >
                  ...
                  <div class="relative z-10 flex flex-col h-full">
                    ...
                    <div class="mb-6 border-b border-white/10 pb-4 flex items-center gap-3">
                      ...
                      <span class="bg-amber-300/20 text-amber-200 text-xs px-2.5 py-1 rounded-full font-medium">
                        2 Pesan
                      </span>
                    </div>
            ...
            >
              ...
              <div class="relative z-10 space-y-12">
                ...
                <div class="space-y-4">
                  <div class="flex justify-center mb-6">
                    <div class="w-16 h-px bg-gradient-to-r from-transparent via-amber-300 to-transparent mx-2 my-auto" />
                    <i class="mdi mdi-gift-outline text-3xl md:text-4xl text-amber-300 mx-4" />
                    <div class="w-16 h-px bg-gradient-to-r from-transparent via-amber-300 to-transparent mx-2 my-auto" />
                  </div>
                  <h2 class="text-xs md:text-sm font-medium tracking-[0.4em] uppercase text-amber-200/80">
                    Wedding Gift
        ...
        <section class="min-h-screen relative snap-start flex flex-col justify-center py-16 md:py-24 overflow-hidden">
          ...
          <div class="relative z-30 max-w-6xl mx-auto px-6 md:px-12 w-full h-full flex flex-col">
            ...
            <div class="text-center space-y-4 mb-10 md:mb-16">
              <div class="flex justify-center mb-4">
                <i class="mdi mdi-camera-outline text-3xl md:text-4xl text-amber-300" />
              </div>
              <h2 class="text-xs md:text-sm font-medium tracking-[0.4em] uppercase text-amber-200/80">
                Our Memories
              </h2>
              <p class="text-4xl md:text-6xl font-serif font-medium tracking-tight text-white tracking-wide mt-2">
                Gallery
              </p>
            </div>
        ...
        <section class="relative w-full min-h-screen overflow-hidden snap-start flex flex-col">
          ...
          <div class="relative z-20 max-w-4xl mx-auto text-center px-6 md:px-12 flex flex-col justify-center flex-1">
            ...
            <!-- Thank You Text -->
            <p class="text-xl md:text-2xl font-serif font-medium tracking-tight text-white/90 mb-4">
            ...
            <p class="text-amber-200 text-sm md:text-base uppercase tracking-[0.25em] font-medium mb-4">
              Romeo & Juliet
            </p>
...
const openLightbox = (src: string) => {
  ...
  lightbox.innerHTML = `<img src="${src}" class="max-h-[90vh] max-w-[90vw] rounded-sm shadow-lg sepia-[.40] contrast-110 saturate-[1.2]" />`
...
const showToast = (message: string, _isError = false) => {
  ...
  toast.className = `
    ...
    z-50 px-6 py-3 rounded-sm text-white backdrop-blur-md bg-white/10

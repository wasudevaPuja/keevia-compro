  ...
  <div class="h-screen flex overflow-hidden">
    ...
    <div class="hidden md:block md:w-4/5 h-screen relative overflow-hidden">
      ...
      <img
        ...
        class="absolute inset-0 w-full h-full object-cover scale-105 brightness-105 saturate-110"
      >
              ...
              <div class="relative z-10 space-y-12">
                ...
                <div class="flex flex-col gap-8 md:gap-10 text-left pt-2 max-w-xl mx-auto">
                  ...
                  <div class="relative pl-6 md:pl-8 border-l border-pink-300/30">
                    ...
                    />
                    <h3 class="font-serif italic text-3xl font-light text-white mb-2">
                      Pemberkatan
                    </h3>
                ...
                <div class="flex flex-col gap-6 pt-6 max-w-2xl mx-auto w-full">
                  ...
                  >
                    ...
                    <div class="space-y-4 relative z-10 flex-1 text-left">
                      ...
                      <h3 class="font-serif italic text-3xl font-light text-white">
                        Kirim Kado Fisik
                      </h3>
            ...
            >
              ...
              >
                ...
                >
                  <img
                    :src="img"
                    class="w-full h-full object-cover brightness-105 saturate-110"
                  >
                  <div

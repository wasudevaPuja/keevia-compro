<template>
  <div class="h-screen flex overflow-hidden">
    ...
    <div class="hidden md:block md:w-4/5 h-screen relative overflow-hidden">
      ...
      <img src="/img/custom_showcase.png" class="absolute inset-0 w-full h-full object-cover scale-105 brightness-105 saturate-110">
      ...
      <div class="absolute bottom-16 left-16 text-white z-10 max-w-xl">
        ...
        <!-- Names -->
        <h1 class="text-6xl lg:text-7xl font-extralight font-serif leading-tight tracking-wide">
    ...
    <div :class="[
      ...
      <div class="relative z-10 h-screen flex flex-col justify-between text-white text-center px-8 py-10">
        ...
        <div>
          ...
          <h1 class="text-4xl md:text-5xl font-extralight font-serif tracking-wide">
            Romeo <span class="text-pink-200">&</span> Juliet
          </h1>
        ...
        <div class="max-w-md mx-auto text-center">
          ...
          <template v-if="!isOpen">
            ...
            <p class="text-xl font-extralight mt-3 text-white">
              {{ guestName }}
            </p>
      ...
      <div v-if="isOpen" class="relative z-10 bg-transparent text-white h-screen scroll-smooth overflow-y-auto
        ...
        <!-- MEMPELAI (The Couple) -->
        <section class="relative w-full bg-[#1a1114]">
          ...
          <div class="flex flex-col w-full text-left">
            ...
            <div class="relative w-full h-screen snap-start group overflow-hidden">
              <img src="/img/groom-pria.jpg" alt="Groom Romeo Axton Montague"
                class="absolute inset-0 w-full h-full object-cover transition-transform duration-[10000ms] ease-linear group-hover:scale-110 brightness-105 saturate-110">
              ...
              <div class="absolute inset-0 flex flex-col justify-end p-8 md:p-16 lg:p-24 z-10 w-full max-w-7xl mx-auto">
                <div
                  ...
                  <div class="flex items-center gap-4">
                    ...
                    <p class="text-xs tracking-[0.3em] uppercase text-pink-200">The Groom</p>
                  </div>

                  <h2 class="text-5xl md:text-6xl lg:text-7xl font-extralight text-white font-serif tracking-wide">
                    Romeo Axton<br><span class="italic text-pink-100">Montague</span>
                  </h2>

                  <div class="pt-4 space-y-1">
                    <p class="text-base md:text-lg text-white/80 font-extralight">
                      Putra Pertama dari
                    </p>
                    <p class="text-base md:text-lg text-white font-medium">
                      Bapak William & Ibu Anne
                    </p>
                  </div>
              ...
              <div
                ...
                <div
                  ...
                  <div class="flex items-center gap-4 flex-row-reverse">
                    <div class="w-12 h-px bg-pink-300" />
                    <p class="text-xs tracking-[0.3em] uppercase text-pink-200">The Bride</p>
                  </div>

                  <h2 class="text-5xl md:text-6xl lg:text-7xl font-extralight text-white font-serif tracking-wide">
                    Juliet<br><span class="italic text-pink-100">Capulet</span>
                  </h2>
        ...
        <section class="min-h-screen relative snap-start flex flex-col justify-center py-16 md:py-24">
          <div class="absolute inset-0 -z-10">
            <video autoplay muted loop playsinline class="w-full h-full object-cover filter brightness-75 contrast-125">
              <source src="/video/wedding-video.mp4" type="video/mp4">
            </video>
          ...
          <div class="relative z-10 w-full max-w-5xl mx-auto px-6 md:px-12">
            ...
            <div class="text-center space-y-4 mb-16 md:mb-20">
              <div class="flex justify-center mb-4">
                <i class="mdi mdi-flower text-4xl md:text-5xl text-pink-300 animate-pulse" />
              </div>
              <p class="text-xs md:text-sm tracking-[0.3em] uppercase text-pink-200/90 font-medium">
                A Journey in Love
              </p>
              <h2 class="text-4xl md:text-5xl lg:text-5xl font-extralight text-white font-serif italic">
                ...
                <div class="relative flex flex-col md:flex-row items-center md:items-start group">
                  ...
                  <div class="md:w-1/2 md:pr-12 text-center md:text-right w-full mb-6 md:mb-0 space-y-2 pr-0 pl-0">
                    ...
                    <div class="hidden md:block mt-4">
                      <span class="text-4xl font-extralight text-pink-200/40 block mb-1">01</span>
                      <h3 class="text-2xl md:text-3xl font-semibold text-white tracking-wide">
                        The Unexpected Comeback
                      </h3>
                      <p class="text-pink-300/80 font-medium mt-1">Juli 2023</p>
                    </div>
                  </div>
                  <!-- Right Content -->
                  <div class="md:w-1/2 md:pl-12 w-full pl-0">
                    <div
                      class="bg-white/5 backdrop-blur-md border border-white/10 rounded-[2rem] p-6 md:p-8 hover:bg-white/15 transition-colors duration-500 shadow-xl relative overflow-hidden group-hover:-translate-y-2 transform transition-all">
                      ...
                      <p class="text-white/80 leading-relaxed text-sm md:text-base font-extralight">
                ...
                <div class="relative flex flex-col md:flex-row-reverse items-center md:items-start group">
                  ...
                  <div class="md:w-1/2 md:pl-12 text-center md:text-left w-full mb-6 md:mb-0 space-y-2 pl-0 pr-0">
                    <div
                      ...
                      2023 - 2025</div>
                    <div class="hidden md:block mt-4">
                      <span class="text-4xl font-extralight text-pink-200/40 block mb-1">02</span>
                      <h3 class="text-2xl md:text-3xl font-semibold text-white tracking-wide">
                        The Beautiful Mess
                      </h3>
                      <p class="text-pink-300/80 font-medium mt-1">2023 - 2025</p>
                    </div>
                  </div>
                  <!-- Left Content -->
                ...
                <div class="relative flex flex-col md:flex-row items-center md:items-start group">
                  ...
                  <div class="md:w-1/2 md:pr-12 text-center md:text-right w-full mb-6 md:mb-0 space-y-2 pr-0 pl-0">
                    <div
                      ...
                      Maret 2026</div>
                    <div class="hidden md:block mt-4">
                      <span class="text-4xl font-extralight text-pink-200/40 block mb-1">03</span>
                      <h3 class="text-2xl md:text-3xl font-semibold text-white tracking-wide">
                        The Forever Chapter
                      </h3>
                      <p class="text-pink-300/80 font-medium mt-1">Maret 2026</p>
                    </div>
                  </div>
                  <!-- Right Content -->
                  <div class="md:w-1/2 md:pl-12 w-full pl-0">
                    <div
                      class="bg-gradient-to-br from-pink-500/20 to-white/5 backdrop-blur-md border border-pink-300/30 rounded-[2rem] p-6 md:p-8 hover:border-pink-300/60 transition-colors duration-500 shadow-[0_8px_32px_rgba(249,168,212,0.15)] relative overflow-hidden group-hover:-translate-y-2 transform transition-all text-left">
        ...
        <section class="min-h-screen relative snap-start flex flex-col justify-center py-16 md:py-24">
          ...
          <div class="absolute inset-0 -z-10 bg-[#1a1114]">
          ...
          <div class="relative z-30 max-w-4xl mx-auto text-center px-6 md:px-12 w-full">
            ...
            <div
              class="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[3rem] p-8 md:p-14 lg:p-20 shadow-[0_8px_40px_rgba(244,114,182,0.15)] border-pink-200/20 relative overflow-hidden group">
              <!-- Decorative elements -->
              <div
              ...
              <div class="relative z-10 space-y-12">
                ...
                <div class="space-y-4">
                  <div class="flex justify-center mb-6">
                    ...
                    <i class="mdi mdi-flower text-3xl md:text-4xl text-pink-300 mx-4" />
                    <div class="w-16 h-px bg-gradient-to-r from-transparent via-pink-300 to-transparent mx-2 my-auto" />
                  </div>
                  <h2 class="text-xs md:text-sm font-medium tracking-[0.4em] uppercase text-pink-200/80">
                    Save Our Date
                  </h2>
                  <p class="text-3xl md:text-5xl font-serif italic font-extralight text-white tracking-wide mt-2">
                    Rabu, 25 Maret 2026
                  </p>
                </div>
                ...
                <div class="py-8 border-y border-white/10 my-10">
                  <div class="grid grid-cols-4 gap-2 md:gap-6 max-w-2xl mx-auto">
                    <!-- Days -->
                    <div
                      class="flex flex-col items-center justify-center p-3 md:p-4 rounded-[2rem] bg-white/5 border border-white/5 hover:bg-white/10 transition-colors">
                      <span class="text-3xl md:text-5xl font-extralight text-white font-serif">{{ countdown.days }}</span>
                      <span
                        class="text-[10px] md:text-xs uppercase tracking-widest text-pink-200/70 mt-2 font-medium">Hari</span>
                    </div>
                    <!-- Hours -->
                    <div
                      class="flex flex-col items-center justify-center p-3 md:p-4 rounded-[2rem] bg-white/5 border border-white/5 hover:bg-white/10 transition-colors">
                      <span class="text-3xl md:text-5xl font-extralight text-white font-serif">{{ countdown.hours }}</span>
                      <span
                        class="text-[10px] md:text-xs uppercase tracking-widest text-pink-200/70 mt-2 font-medium">Jam</span>
                    </div>
                    <!-- Minutes -->
                    <div
                      class="flex flex-col items-center justify-center p-3 md:p-4 rounded-[2rem] bg-white/5 border border-white/5 hover:bg-white/10 transition-colors">
                      <span class="text-3xl md:text-5xl font-extralight text-white font-serif">{{ countdown.minutes }}</span>
                      <span
                        class="text-[10px] md:text-xs uppercase tracking-widest text-pink-200/70 mt-2 font-medium">Menit</span>
                    </div>
                    <!-- Seconds -->
                    <div
                      class="flex flex-col items-center justify-center p-3 md:p-4 rounded-[2rem] bg-white/5 border border-white/5 hover:bg-white/10 transition-colors">
                      <span class="text-3xl md:text-5xl font-extralight text-pink-300 font-serif">{{ countdown.seconds
                      }}</span>
                      <span
                ...
                <div class="flex flex-col gap-8 md:gap-10 text-left pt-2 max-w-xl mx-auto">
                  ...
                  <div class="relative pl-6 md:pl-8 border-l border-pink-300/30">
                    ...
                    <h3 class="font-serif italic text-3xl font-light text-white mb-2">Pemberkatan</h3>
                    <div class="space-y-3 text-white/80 font-extralight text-sm md:text-base">
                      <p class="flex items-center gap-3">
                        <UIcon name="mdi:clock-outline" class="w-4 h-4 text-pink-300/70" />
                        07.00 - 11.00 WITA
                      </p>
                  ...
                  <div class="relative pl-6 md:pl-8 border-l border-pink-300/30">
                    <div
                      class="absolute -left-[5px] top-1.5 w-2 h-2 rounded-full bg-pink-300 shadow-[0_0_10px_rgba(249,168,212,0.8)]" />
                    <h3 class="font-serif italic text-3xl font-light text-white mb-2">Wedding Reception</h3>
                    <div class="space-y-3 text-white/80 font-extralight text-sm md:text-base">
                      <p class="flex items-center gap-3">
                        <UIcon name="mdi:clock-outline" class="w-4 h-4 text-pink-300/70" />
                        15.00 - 22.00 WITA
                ...
                <div class="pt-6">
                  <a href="https://www.google.com/maps/place/Jl.+Batu+Luwih+Kawan,+Penebel,+Tabanan" target="_blank"
                    ...
                    <UIcon name="mdi:google-maps" class="w-5 h-5 text-pink-300" />
                    Buka di Google Maps
                  </a>
                </div>
              </div>
        ...
        <section class="min-h-screen relative snap-start flex flex-col justify-center py-16 md:py-24">
          ...
          <div class="relative z-30 max-w-4xl mx-auto text-center px-6 md:px-12 w-full">
            ...
            <div class="flex flex-col gap-12">
              ...
              <div class="space-y-8 lg:text-left">
                ...
                <div class="space-y-4 text-center lg:text-left">
                  <div class="flex justify-center lg:justify-start mb-4">
                    <i class="mdi mdi-flower text-3xl md:text-4xl text-pink-300" />
                  </div>
                  <h2 class="text-xs md:text-sm font-medium tracking-[0.4em] uppercase text-pink-200/80">
                    RSVP & Wishes
                  </h2>
                  <p class="text-4xl md:text-5xl font-serif italic font-extralight text-white tracking-wide mt-2">
                    Kehadiran Anda
                  </p>
                ...
                <!-- Form RSVP -->
                <form
                  class="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[3rem] p-6 md:p-10 shadow-[0_8px_40px_rgba(244,114,182,0.15)] border-pink-200/20 relative overflow-hidden group space-y-6">
                  ...
                  <div class="relative z-10 space-y-6">
                    ...
                    <div class="flex flex-col text-left space-y-2">
                      <label for="nama" class="text-xs tracking-widest uppercase text-pink-200/80 font-medium ml-1">Nama
                        Lengkap</label>
                      <input id="nama" type="text" name="nama" placeholder="Tuliskan nama Anda"
                        class="w-full px-5 py-3.5 rounded-[2rem] bg-gradient-to-br from-white/10 to-pink-500/5 border border-pink-200/20 backdrop-blur-2xl text-white placeholder-white/30 focus:outline-none focus:border-pink-300/50 focus:bg-white/10 transition-all font-extralight"
                        required>
                    </div>

                    <!-- Konfirmasi Kehadiran -->
                    <div class="flex flex-col text-left space-y-3">
                      <p class="text-xs tracking-widest uppercase text-pink-200/80 font-medium ml-1">Konfirmasi
                        Kehadiran</p>
                      <div class="flex flex-col sm:flex-row gap-4">
                        <label class="flex-1 cursor-pointer">
                          <input type="radio"  name="kehadiran" value="Hadir" class="peer sr-only"
                            required>
                          <div
                            class="px-5 py-3.5 rounded-[2rem] bg-gradient-to-br from-white/10 to-pink-500/5 border border-pink-200/20 backdrop-blur-2xl text-white/70 text-center peer-checked:bg-pink-300/20 peer-checked:border-pink-300/50 peer-checked:text-white transition-all font-extralight hover:bg-white/10">
                            Ya, Saya Hadir
                          </div>
                        </label>
                        <label class="flex-1 cursor-pointer">
                          <input type="radio"  name="kehadiran" value="Tidak Hadir"
                            class="peer sr-only">
                          <div
                            class="px-5 py-3.5 rounded-[2rem] bg-gradient-to-br from-white/10 to-pink-500/5 border border-pink-200/20 backdrop-blur-2xl text-white/70 text-center peer-checked:bg-white/20 peer-checked:border-white/30 peer-checked:text-white transition-all font-extralight hover:bg-white/10">
                            Tidak Hadir
                          </div>
                        </label>
                      </div>
                    ...
                    <div class="flex flex-col text-left space-y-2">
                      <label for="ucapan"
                        class="text-xs tracking-widest uppercase text-pink-200/80 font-medium ml-1">Ucapan &
                        Doa</label>
                      <textarea id="ucapan" name="ucapan" rows="4"
                        placeholder="Berikan doa terbaik Anda untuk kedua mempelai"
                        class="w-full px-5 py-4 rounded-[2rem] bg-gradient-to-br from-white/10 to-pink-500/5 border border-pink-200/20 backdrop-blur-2xl text-white placeholder-white/30 focus:outline-none focus:border-pink-300/50 focus:bg-white/10 transition-all font-extralight resize-none" />
                    </div>

                    <!-- Tombol Kirim -->
                    <button type="submit"
                      class="w-full py-4 bg-pink-300 hover:bg-pink-400 text-gray-900 rounded-[2rem] text-sm font-medium tracking-wide transition-all duration-300 hover:shadow-[0_0_20px_rgba(249,168,212,0.4)] hover:-translate-y-1 flex justify-center items-center gap-2 mt-4">
              ...
              <div class="h-full">
                <div
                  class="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[3rem] p-6 md:p-8 h-full min-h-[500px] flex flex-col shadow-[0_8px_40px_rgba(244,114,182,0.15)] border-pink-200/20 relative overflow-hidden group">
                  ...
                  <div class="relative z-10 flex flex-col h-full">
                    ...
                    <div class="flex-1 overflow-y-auto space-y-4 pr-2 max-h-[500px] md:max-h-[600px] scrollbar-hide">
                        <!-- Message 1 -->
                        <div class="bg-white/5 border border-white/5 p-5 rounded-[2rem] space-y-3 hover:bg-white/10 transition-colors text-left">
                          ...
                          <p class="text-white/70 text-sm font-extralight leading-relaxed">
            ...
            <div
              ...
              <div class="relative z-10 space-y-12">
                ...
                <div class="flex flex-col gap-6 pt-6 max-w-2xl mx-auto w-full">
                  ...
                  <div
                    class="bg-gradient-to-br from-white/10 to-pink-500/5 border border-pink-200/20 backdrop-blur-2xl rounded-[2rem] p-6 md:p-8 text-white flex flex-col justify-between hover:bg-white/10 hover:-translate-y-1 transition-all duration-300 group/card relative overflow-hidden">
                    <div
                    ...
                    <div class="space-y-4 relative z-10 flex-1 text-left">
                      ...
                      <h3 class="font-serif italic text-3xl font-light text-white">Kirim Kado Fisik</h3>
                      <p class="text-white/70 font-extralight text-sm leading-relaxed pb-4">
                    ...
                    <a href="https://www.google.com/maps/place/Jl.+Batu+Luwih+Kawan,+Penebel,+Tabanan" target="_blank"
                      class="w-full relative z-10 flex items-center justify-center gap-2 px-5 py-3.5 bg-white/10 hover:bg-white/20 border border-white/10 rounded-full hover:shadow-[0_0_20px_rgba(244,114,182,0.4)] text-sm font-medium tracking-wide transition-all text-white mt-auto">
                  ...
                  <div
                    ...
                    <div class="space-y-4 relative z-10 flex-1 text-left">
                      ...
                      <h3 class="font-serif italic text-3xl font-light text-white">Transfer Bank</h3>
                      <div class="space-y-2">
                    ...
                    <button
                      class="w-full mt-6 relative z-10 flex items-center justify-center gap-2 px-5 py-3.5 bg-blue-500 hover:bg-blue-600 text-white rounded-full hover:shadow-[0_0_20px_rgba(244,114,182,0.4)] text-sm font-medium tracking-wide transition-all shadow-lg"
                  ...
                  <div
                    class="bg-gradient-to-br from-white/10 to-pink-500/5 border border-pink-200/20 backdrop-blur-2xl rounded-[2rem] p-6 md:p-8 text-white flex flex-col justify-between hover:bg-white/10 hover:-translate-y-1 transition-all duration-300 group/card relative overflow-hidden md:col-span-2 lg:col-span-1">
                    <div
                    ...
                    <div class="space-y-4 relative z-10 flex-1 text-left">
                      ...
                      <h3 class="font-serif italic text-3xl font-light text-white">Dompet Digital</h3>
                      <div class="space-y-2">
                    ...
                    <button
                      class="w-full mt-6 relative z-10 flex items-center justify-center gap-2 px-5 py-3.5 bg-green-500 hover:bg-green-600 text-white rounded-full hover:shadow-[0_0_20px_rgba(244,114,182,0.4)] text-sm font-medium tracking-wide transition-all shadow-lg"
        ...
        <section class="min-h-screen relative snap-start flex flex-col justify-center py-16 md:py-24 overflow-hidden">
          ...
          <div class="relative z-30 max-w-6xl mx-auto px-6 md:px-12 w-full h-full flex flex-col">
            ...
            <div class="text-center space-y-4 mb-10 md:mb-16">
              ...
              <p class="text-4xl md:text-6xl font-serif italic font-extralight text-white tracking-wide mt-2">
                Gallery
              </p>
            </div>
            ...
            <div
              class="relative flex-1 w-full bg-white/5 backdrop-blur-md border border-white/10 rounded-[3rem] p-6 md:p-8 shadow-[0_8px_40px_rgba(244,114,182,0.15)] border-pink-200/20">
              ...
              <!-- Image Display -->
              <div class="relative w-full h-[60vh] md:h-[70vh] rounded-[2rem] overflow-hidden group">
                ...
                <transition-group name="fade" tag="div" class="absolute inset-0 w-full h-full">
                  <div v-for="(img, idx) in images" :key="img" v-show="current === idx"
                    ...
                    <img :src="img"
                      class="absolute inset-0 w-full h-full object-cover transition-transform duration-[10000ms] ease-linear hover:scale-105 cursor-pointer brightness-105 saturate-110"
              ...
              <div ref="thumbContainer"
                ...
                <button v-for="(img, idx) in images" :key="'thumb-' + idx" ref="thumbs"
                  class="relative w-16 h-16 md:w-24 md:h-24 flex-shrink-0 rounded-full hover:shadow-[0_0_20px_rgba(244,114,182,0.4)] overflow-hidden border-2 transition-all duration-300"
                  ...
                  @click="current = idx">
                  <img :src="img" class="w-full h-full object-cover brightness-105 saturate-110">
        ...
        <section class="relative w-full min-h-screen overflow-hidden snap-start flex flex-col">
          ...
          <div class="relative z-20 max-w-4xl mx-auto text-center px-6 md:px-12 flex flex-col justify-center flex-1">
            ...
            <!-- Thank You Text -->
            <p class="text-xl md:text-2xl font-serif italic font-extralight text-white/90 mb-4">
...
const openLightbox = (src: string) => {
  ...
  lightbox.innerHTML = `<img src="${src}" class="max-h-[90vh] max-w-[90vw] rounded-[2rem] shadow-lg brightness-105 saturate-110" />`
...
const showToast = (message: string, _isError = false) => {
  ...
  toast.className = `
    ...
    z-50 px-6 py-3 rounded-[2rem] text-white backdrop-blur-md bg-white/10
